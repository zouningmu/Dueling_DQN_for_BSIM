...
def buffer_sample_training(buffer1, mini_size1, agent):
    if buffer1.len() > mini_size1:
        b_s1, b_a1, b_r1, b_ns1, b_d1, ind1, normed_is_weight1 = buffer1.sample(mini_size1)
        transition_dict1 = {
            'states': b_s1,
            'actions': b_a1,
            'next_states': b_ns1,
            ...
            'dones': b_d1,
            'ind': ind1,
            'Normed_IS_weight': normed_is_weight1,
        }

        agent.update(transition_dict1, buffer1)
